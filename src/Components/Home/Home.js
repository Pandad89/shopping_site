...
function Home() {
    ...
    const handlePrintArr = () => {
        return tempArr.map((item, index) => {
            return (
                <div key={index} className="Home__RenderedItems">
        ...
        return tempArr.map((item, index) => {
            return (
                <div className="Home__ShoppingCart__Items">
                    ...
                    {/* <button onClick={console.log("pay")}>Pay</button> */}
                </div>
            )
        })
    }
    ...
    return (
        <div className="Home">
            <button className="Home__ShoppingCart__Button"><h3>Shopping Cart <span>&nbsp;{counter}&nbsp;</span></h3></button>
